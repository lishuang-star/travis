...
<html lang="<?php echo $config->getLanguage(); ?>">
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>The default <a href='siteConfigurations'>site config</a>, you can find on the menu-point. But there are more settings avaible; go to the <a href='plugins'>plugins</a> and check the "CustomiseAdvanced"-Plugin.</p>
            ...
            <p>It can be, that you will need a database-update after. For this, go as admin to the menu-point "<a href='update'>Update version</a>".</p>
            <p>Done!</p>
            ...
            <p>Some information can help us, to find your problem faster:</p> <ul><li>Content of <a href='videos/youphptube.log'>videos/youphptube.log</a></li><li>Content of <a href='videos/youphptube.js.log'>videos/youphptube.js.log</a></li><li>If public: your domain, so we can try it</li></ul>
