    ...
    <nav class="navbar navbar-inverse playlistList">
        <ul class="nav navbar-nav">
            ...
            <li class="<?php echo $class; ?>">
                    <a href="playlist/<?php echo $playlist_id; ?>/<?php echo $count; ?>" title="<?php echo $value['title']; ?>" class="videoLink row">
                        ...
                        <div class="col-md-3 col-sm-3 col-xs-3 nopadding">
                            ...
                            <meta itemprop="contentURL" content="<?php $catLink, "video/", $value['clean_title']; ?>" />
                            <meta itemprop="embedURL" content="<?php  "videoEmbeded/", $value['clean_title']; ?>" />
