...
if ($obj->BigVideo && empty($_GET['showOnly'])) {
    ...
    <div class="clear clearfix">
        <div class="row thumbsImage">
            <div class="col-sm-6">
                <a href="cat/<?php echo $video['clean_category']; ?>/video/<?php echo $video['clean_title']; ?>" title="<?php echo $video['title']; ?>" style="">
                    <?php
                    ...
                    <div class="aspectRatio16_9">
                        ...
                        <?php if (!empty($imgGif)) { ?>
                            <img src="img/loading-gif.png" data-src="<?php echo $imgGif; ?>" style="position: absolute; top: 0; display: none;" alt="<?php echo $video['title']; ?>" id="thumbsGIF<?php echo $video['id']; ?>" class="thumbsGIF img-responsive <?php echo @$img_portrait; ?>  rotate<?php echo $video['rotation']; ?>" height="130" />
    <?php } ?>
                    </div>
            ...
            <div class="col-sm-6">
                <a class="h6" href="video/<?php echo $video['clean_title']; ?>" title="<?php echo $video['title']; ?>">
                ...
                <div class="text-muted galeryDetails">
                    <div>
                            ...
                            <a class="label label-default" href="cat/<?php echo $video['clean_category']; ?>/">
                                <?php
    ...
    <?php if (Video::canEdit($video['id'])) { ?>
                        <div>
                            <a href="mvideos?video_id=<?php echo $video['id']; ?>" class="text-primary"><i class="fa fa-edit"></i> <?php echo __("Edit Video"); ?></a>
                        </div>
                    <?php } ?>
                    <?php
                    if ($config->getAllow_download()) {
                        ...
                        ?>
                        <div><a class="label label-default " role="button" href="<?php echo  "videos/" . $video['filename'] . $ext; ?>" download="<?php echo $video['title'] . $ext; ?>"><?php echo __("Download"); ?></a></div>
    <?php } ?>
                </div>
            </div>
        </div>
    ...
    ?>
    <a href="" class="btn btn-default"><i class="fa fa-arrow-left"></i> <?php echo __("Go Back"); ?></a>    
    <?php
}
