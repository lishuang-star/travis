    ...
    if (!empty($user->getEmail())) {
        ...
        if ($user->save()) {
            ...
            if ($valid) {
                ...
                $msg = __("You asked for a recover link, click on the provided link") . " <a href='recoverPass?user={$_POST['user']}&recoverpass={$recoverPass}'>" . __("Reset password") . "</a>";
